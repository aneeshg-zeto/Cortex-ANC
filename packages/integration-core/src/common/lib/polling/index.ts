import { AppConnectionValueForAuthProperty, FilesService, Store } from '@cortex/integration-core/framework';
import { isNil } from '@cortex/integration-core/shared-stubs';
